...
@if (isset($term_condition))
    @section('title', __('website::dashboard.website') . ' - ' . __('website::dashboard.edit_term_condition'))

    @section('subheader')
        @include('dashboard.layouts.partials.sub_header', [
            'module_name' => __('website::dashboard.edit_term_condition'),
            'short_description' => __('website::dashboard.enter_term_condition_details_and_submit'),
            'breadcrumbs' => [],
        ]);
    @endsection
@else
    @section('title', __('website::dashboard.website') . ' - ' . __('website::dashboard.create_term_condition'))
    @section('subheader')
        @include('dashboard.layouts.partials.sub_header', [
            'module_name' => __('website::dashboard.new_term_condition'),
            'short_description' => __('website::dashboard.enter_term_condition_details_and_submit'),
            'breadcrumbs' => [],
        ]);
    @endsection
    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    {{ isset($term_condition) ? __('website::dashboard.edit_term_condition') : __('website::dashboard.new_term_condition') }}
                    <i class="mr-2"></i>
                    <small class=""></small>
                </h3>
            </div>
        ...
        <form class="form parsley-form" action="{{ $action }}" method="POST" enctype="multipart/form-data">
            ...
            @method($method)
            <div class="card-body">
                <div id="kt_term_condition_translation_repeater">
                    <div class="form-group row">
                        <div data-repeater-list="translations" class="col-lg-12">
                            @forelse (old('translations', $term_condition->translations ?? []) as $translation)
                                    ...
                                    <div class="col-md-3">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                @endif
                                                <span
                                                    class="form-text text-muted">{{ __('website::dashboard.the_language_of_the_term_condition_title_and_description') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div data-repeater-item class="form-group row align-items-top">
                                    ...
                                    <div class="col-md-3">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <x-dashboard.form.inputs.text :id="''" :class="'form-control'"
                                                    :name="'title'" :placeholder="__('website::dashboard.term_condition_title')" :value="''"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-1">
                        <x-dashboard.form.inputs.success-switch class="mx-2" :id="'is_active'" :name="'is_active'"
                            :isChecked="old('is_active', $term_condition->is_active ?? '')" />
                    </div>
                    <div class="col-1"></div>
                    <label
                    ...
                    <div class="col-2">
                        <x-dashboard.form.inputs.number :id="'display_order'" :class="'form-control'" :name="'display_order'" :integerValidationMessage="__('website::dashboard.display_order_must_be_integer')"
                            :placeholder="__('website::dashboard.display_order')" :value="old('display_order', $term_condition->display_order ?? '')" />
                    </div>
                </div>
            </div>
...
@push('javascript')
    ...
    <!--end::Form JS-->
    <!-- Custom JS -->
    @include('website::terms_conditions.creating_editing.scripts')
    <!--end::Custom JS-->
@endpush
