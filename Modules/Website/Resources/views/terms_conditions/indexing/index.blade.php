...
@section('title', __('website::dashboard.terms_conditions'));
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('dashboard.website.privacy-policies.index') }}"
                                class="text-muted">{{ __('website::dashboard.terms_conditions') }}</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">{{ __('website::dashboard.terms_conditions') }}</h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('dashboard.website.terms-conditions.create') }}" class="btn btn-primary font-weight-bolder">
                    <i class="fas fa-user-shield"></i>
                    {{ __('website::dashboard.new_term_condition') }}</a>
                <!--end::Button-->
            </div>
        </div>
        <div class="card-body">
            <!--begin: Datatable-->
            <table class="table table-bordered table-hover table-checkable" id="kt_datatable_terms_conditions"
...
@push('javascript')
    ...
    @include('website::terms_conditions.indexing.scripts');
@endpush
