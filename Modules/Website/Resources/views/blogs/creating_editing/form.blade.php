...
@if (isset($blog))
    @section('title', __('website::dashboard.website') . ' - ' . __('website::dashboard.edit_blog'))

    @section('subheader')
        @include('dashboard.layouts.partials.sub_header', [
            'module_name' => __('website::dashboard.edit_blog'),
            'short_description' => __('website::dashboard.enter_blog_details_and_submit'),
            'breadcrumbs' => [],
        ]);
    @endsection
@else
    @section('title', __('website::dashboard.website') . ' - ' . __('website::dashboard.create_blog'))
    @section('subheader')
        @include('dashboard.layouts.partials.sub_header', [
            'module_name' => __('website::dashboard.new_blog'),
            'short_description' => __('website::dashboard.enter_blog_details_and_submit'),
            'breadcrumbs' => [],
        ]);
    @endsection
    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    {{ isset($blog) ? __('website::dashboard.edit_blog') : __('website::dashboard.new_blog') }}
                    <i class="mr-2"></i>
                    <small class=""></small>
                </h3>
            </div>
            <div class="card-toolbar">
                <a href="{{ route('dashboard.website.blogs.index') }}" class="btn btn-light-primary font-weight-bolder mr-2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-2">
                        <x-dashboard.form.inputs.select :id="'category_id'" :name="'category_id'" :options="$categories"
                            :isMultiple="false" :defaultOptionName="__('website::dashboard.select_category')" :selectedOption="old('category_id', $blog->category_id ?? '')" />
                    </div>
                </div>
                <div id="kt_blog_translation_repeater">
                    <div class="form-group row">
                        <div data-repeater-list="translations" class="col-12">
                            @forelse (old('translations', $blog->translations ?? []) as $translation)
                                <div data-repeater-item class="row align-items-top">
                                    <div class="col-3">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                ...
                                                @endif
                                                <span
                                                    class="form-text text-muted">{{ __('website::dashboard.the_language_of_the_blog_details') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 my-6">
                                        <div class="row">
                                            <label
                                                class="col-1 col-form-label text-center">{{ __('website::dashboard.short_description') }}:</label>
                                            <div class="col-3">
                                                @if (is_array($translation))
                                                    <x-dashboard.form.inputs.text-area :id="''" :class="'form-control'"
                                                        :name="'short_description'" :placeholder="__('website::dashboard.short_description')" :value="$translation['short_description']"
                                                        :isRequired="true" :requiredMessage="__(
                                                            'website::dashboard.short_description_is_required',
                                                        )" />
                                                @else
                                                    <x-dashboard.form.inputs.text-area :id="''" :class="'form-control'"
                                                        :name="'short_description'" :placeholder="__('website::dashboard.short_description')" :value="$translation->short_description"
                                            ...
                                            <label
                                                class="col-2 col-form-label text-right">{{ __('website::dashboard.description') }}:</label>
                                            <div class="col-5">
                                                @if (is_array($translation))
                                ...
                                <div data-repeater-item class="form-group row align-items-top">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <x-dashboard.form.inputs.text :id="''" :class="'form-control title-input'"
                                                    :name="'title'" :placeholder="__('website::dashboard.blog_title')" :value="''"
                                                    :isRequired="true" :requiredMessage="__('website::dashboard.title_is_required')" :maxlength="255"
                                                    :maxlengthMessage="__(
                                                        'website::dashboard.number_of_characters_must_less_than_or_equal_255',
                                                    )" />
                                            ...
                                            <div class="col-5">
                                                <x-dashboard.form.inputs.text :id="''" :class="'form-control slug-input'"
                                                    :name="'slug'" :placeholder="__('website::dashboard.blog_slug')" :value="''"
                                                    :isRequired="true" :requiredMessage="__('website::dashboard.slug_is_required')" :maxlength="255"
                                                    :maxlengthMessage="__(
                                                        'website::dashboard.number_of_characters_must_less_than_or_equal_255',
                                                    )" />
                                    ...
                                    <div class="col-12 my-6">
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <x-dashboard.form.inputs.text-area :id="''" :class="'form-control'"
                                                    :name="'short_description'" :placeholder="__('website::dashboard.short_description')" :value="''"
                                                    :isRequired="true" :requiredMessage="__('website::dashboard.short_description_is_required')" />
                                            </div>
                                            <label
                                                class="col-2 col-form-label text-right">{{ __('website::dashboard.description') }}:</label>
                                            <div class="col-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-1">
                        <x-dashboard.form.inputs.success-switch class="mx-2" :id="'is_active'" :name="'is_active'"
                            :isChecked="old('is_active', $blog->is_active ?? '')" />
                    </div>
                    <div class="col-1"></div>
                    <label class="col-xl-2 col-2 col-form-label text-center">{{ __('website::dashboard.image') }}</label>
                    <div class="col-2 col-xl-2">
                        <div class="image-input image-input-empty image-input-outline"
                            style="background-image: url('{{ $blog->image_url ?? global_asset('metronic/assets/media/users/blank.png') }}')"
                            id="image">
...
@push('javascript')
    ...
    <!--end::Form JS-->
    <!-- Custom JS -->
    @include('website::blogs.creating_editing.scripts')
    <!--end::Custom JS-->
@endpush
