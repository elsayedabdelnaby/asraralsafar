...
@section('title', __('website::dashboard.aboutus'));
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('dashboard.website.about-us.index') }}"
                                class="text-muted">{{ __('website::dashboard.about_us') }}</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">{{ __('website::dashboard.aboutus') }}</h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('dashboard.website.about-us.create') }}"
                    class="btn btn-primary font-weight-bolder">
                    <i class="fas fa-user-shield"></i>
                    {{ __('website::dashboard.new_about_us') }}</a>
                <!--end::Button-->
            </div>
        </div>
        <div class="card-body">
            <!--begin: Datatable-->
            <table class="table table-bordered table-hover table-checkable" id="kt_datatable_about_us"
...
@push('javascript')
    ...
    @include('website::aboutus.indexing.scripts');
@endpush
