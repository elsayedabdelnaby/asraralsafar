...
@if (isset($about_us))
    @section('title', __('website::dashboard.website') . ' - ' . __('website::dashboard.edit_about_us'))

    @section('subheader')
        @include('dashboard.layouts.partials.sub_header', [
            'module_name' => __('website::dashboard.edit_about_us'),
            'short_description' => __('website::dashboard.enter_about_us_details_and_submit'),
            'breadcrumbs' => [],
        ]);
    @endsection
@else
    @section('title', __('website::dashboard.website') . ' - ' . __('website::dashboard.create_about_us'))
    @section('subheader')
        @include('dashboard.layouts.partials.sub_header', [
            'module_name' => __('website::dashboard.new_about_us'),
            'short_description' => __('website::dashboard.enter_about_us_details_and_submit'),
            'breadcrumbs' => [],
        ]);
    @endsection
    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    {{ isset($about_us) ? __('website::dashboard.edit_about_us') : __('website::dashboard.new_about_us') }}
                    <i class="mr-2"></i>
                    <small class=""></small>
                </h3>
            </div>
            <div class="card-toolbar">
                <a href="{{ route('dashboard.website.about-us.index') }}"
        ...
        <form class="form parsley-form" action="{{ $action }}" method="POST" enctype="multipart/form-data">
            ...
            @method($method)
            <div class="card-body">
                <div id="kt_about_us_translation_repeater">
                    <div class="form-group row">
                        <div data-repeater-list="translations" class="col-lg-12">
                            @forelse (old('translations', $about_us->translations ?? []) as $translation)
                                    ...
                                    <div class="col-md-3">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                @endif
                                                <span
                                                    class="form-text text-muted">{{ __('website::dashboard.the_language_of_the_about_us_title_and_description') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div data-repeater-item class="form-group row align-items-top">
                                    ...
                                    <div class="col-md-3">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <x-dashboard.form.inputs.text :id="''" :class="'form-control'"
                                                    :name="'title'" :placeholder="__('website::dashboard.about_us_title')" :value="''"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-1">
                        <x-dashboard.form.inputs.success-switch class="mx-2" :id="'is_active'" :name="'is_active'"
                            :isChecked="old('is_active', $about_us->is_active ?? '')" />
                    </div>
                    <div class="col-1"></div>
                    <label
                    ...
                    <div class="col-2">
                        <x-dashboard.form.inputs.number :id="'display_order'" :class="'form-control'" :name="'display_order'" :integerValidationMessage="__('website::dashboard.display_order_must_be_integer')"
                            :placeholder="__('website::dashboard.display_order')" :value="old('display_order', $about_us->display_order ?? '')" />
                    </div>
                </div>
            </div>
...
@push('javascript')
    ...
    <!--end::Form JS-->
    <!-- Custom JS -->
    @include('website::aboutus.creating_editing.scripts')
    <!--end::Custom JS-->
@endpush
