...
@section('title', __('website::dashboard.footer_links'));
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('dashboard.website.footer-links.index', ['footer_section_id' => $footer_section_id]) }}"
                                class="text-muted">{{ __('website::dashboard.footer_links') }}</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">{{ __('website::dashboard.footer_links') }}</h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('dashboard.website.footer-links.create', ['footer_section_id' => $footer_section_id]) }}"
                    class="btn btn-primary font-weight-bolder">
                    <i class="flaticon2-plus-1"></i>
                    {{ __('website::dashboard.new_footer_link') }}</a>
                <!--end::Button-->
            </div>
        </div>
        <div class="card-body">
            <!--begin: Datatable-->
            <table class="table table-bordered table-hover table-checkable" id="kt_datatable_footer_links"
                ...
                <thead>
                    <tr>
                        ...
                        <th>{{ __('website::dashboard.link') }}</th>
...
@push('javascript')
    ...
    @include('website::footer_links.indexing.scripts');
@endpush
