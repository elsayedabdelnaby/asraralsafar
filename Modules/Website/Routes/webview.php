...
use App\Http\Middleware\WebsiteFrontEnd;
...
use Modules\Website\Http\Controllers\Website\ServiceController;
...
Route::group(['middleware' => [WebsiteFrontEnd::class]], function () {
    ...
    Route::get('/services/{slug}', [ServiceController::class, 'show'])->name('website.services.show');
