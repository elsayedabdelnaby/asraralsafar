<script>
    "use strict";
    $(function() {
        let getCateogriesURL = `{{ route('dashboard.settings.categories.index') }}`;
        window.cateogriesTable = initCateogriesTable(getCateogriesURL);
    ...
    function initCateogriesTable(url) {
        return $('#kt_datatable_categories').DataTable({
            responsive: true,
            searchDelay: 500,
            processing: true,
            serverSide: true,
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        if (localStorage.getItem('canUpdateCategory')) {
                            let editUrl =
                                `{{ route('dashboard.settings.categories.edit', ['id']) }}`;
