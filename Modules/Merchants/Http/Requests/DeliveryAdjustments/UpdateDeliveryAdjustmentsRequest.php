...
class UpdateDeliveryAdjustmentsRequest extends FormRequest
{
    /**
    ...
    {
        return [
             'id' => 'required|exists:delivery_adjustments,id,deleted_at,NULL',
            'day' => ['required','array',new CheckIfDaysIsCorrect()],
            'translations'=>['required','array',(new CheckUniqueAdjustmentName(request('id')))],
