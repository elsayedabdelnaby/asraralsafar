...
class UpdateMerchantBranchWithManagerRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return array_merge($store_merchant_branch_with_mangers_rules, (new StoreMerchantBranchRequest($this->request->get('id')))->rules());
    }
