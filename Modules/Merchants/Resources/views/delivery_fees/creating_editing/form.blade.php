...
@if(isset($merchant_delivery_fees))
    @section('title', __('merchants::dashboard.merchants_management') . ' - ' . __('merchants::dashboard.edit_merchant_delivery_fees'))
    @section('subheader')
        @include('dashboard.layouts.partials.sub_header', [
            'module_name' => __('merchants::dashboard.edit_merchant_delivery_fees'),
            'short_description' => __('merchants::dashboard.enter_merchant_delivery_fees_details_and_submit'),
        ]);
    @endsection
@else
    @section('title', __('merchants::dashboard.merchants_management') . ' - ' . __('merchants::dashboard.new_delivery_fees'))
    @section('subheader')
        @include('dashboard.layouts.partials.sub_header', [
            'module_name' => __('merchants::dashboard.new_merchant_delivery_fees'),
            'short_description' => __('merchants::dashboard.enter_merchant_delivery_fees_details_and_submit'),
        ]);
    @endsection
@endif
    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    {{ isset($merchant_delivery_fees) ? __('merchants::dashboard.edit_merchant_delivery_fees') :  __('merchants::dashboard.new_delivery_fees')  }}
                    <i class="mr-2"></i>
                    <small class=""></small>
                </h3>
            </div>
            <div class="card-toolbar">
                <a href="{{ route('dashboard.merchants.merchant-fees.index',['merchant_id'=>$merchant->id]) }}"
        ...
        <form class="form parsley-form" action="{{ $action }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7">
                                <x-dashboard.form.inputs.number
                                    ...
                                    :value="old('merchant_fees',isset($merchant_delivery_fees) ? $merchant_delivery_fees->fees : '')"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7">
                                <x-dashboard.form.inputs.number
                                    ...
                                    :value="old('merchant_fees_from',isset($merchant_delivery_fees) ? $merchant_delivery_fees->from : '')"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7">
                                <x-dashboard.form.inputs.number
                                    ...
                                    :value="old('merchant_fees_to',isset($merchant_delivery_fees) ? $merchant_delivery_fees->to : '')"
                                />
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer">
                <div class="float-right mb-3">
                    ...
                    <a
                        href="{{ route('dashboard.merchants.merchant-fees.index',['merchant_id'=>$merchant->id])}}"
