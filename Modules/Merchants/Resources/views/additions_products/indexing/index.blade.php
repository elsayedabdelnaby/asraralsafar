                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('dashboard.merchants.additions-products.index',['merchant_id'=>$merchant->id]) }}" class="text-muted">
                                {{ __('merchants::dashboard.additions_products') }}
                            </a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('dashboard.merchants.additions-products.create',['merchant_id'=>$merchant->id]) }}" class="btn btn-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
                        <i class="fas fa-plus"></i>
                    </span>{{ __('merchants::dashboard.new_merchant_additions_products') }}
                </a>
...
@push('javascript')
    ...
    @include('merchants::additions_products.indexing.scripts');
@endpush
