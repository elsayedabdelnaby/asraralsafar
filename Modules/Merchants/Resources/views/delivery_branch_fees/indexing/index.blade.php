                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('dashboard.merchants.branch-fees.index',['merchant_id'=>$merchant->id,'branch_id'=>$merchantBranch->id]) }}" class="text-muted">
                                {{ __('merchants::dashboard.branch_delivery_fees') }}
                            </a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('dashboard.merchants.branch-fees.create',['merchant_id'=>$merchant->id,'branch_id'=>$merchantBranch->id]) }}" class="btn btn-primary font-weight-bolder">
...
@push('javascript')
    ...
    @include('merchants::delivery_branch_fees.indexing.scripts');
@endpush
