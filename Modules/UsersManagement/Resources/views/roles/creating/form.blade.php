...
@section('subheader')
    @include('dashboard.layouts.partials.sub_header', [
        'module_name' => __('usersmanagement::dashboard.new_role'),
        'short_description' => __('usersmanagement::dashboard.enter_role_details_and_submit'),
        'breadcrumbs' => [],
    ]);
@endsection
    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">{{ __('usersmanagement::dashboard.new_role') }}
                    <i class="mr-2"></i>
                    <small class=""></small>
                </h3>
            </div>
        ...
        <form class="form parsley-form" enctype="multipart/form-data" method="POST"
            action="{{ route('dashboard.users-management.roles.store') . '?report_to=' . $report_to }}">
            @method('post')
            @csrf
            <div class="card-body">
                                ...
                                <div data-repeater-item class="form-group row align-items-top">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <x-dashboard.form.inputs.text :id="''" :class="'form-control'"
                                                    :name="'name'" :placeholder="__('usersmanagement::dashboard.role_name')" :value="''"
                                                    :isRequired="true" :requiredMessage="__('usersmanagement::dashboard.name_is_required')" :maxlength="100"
                                                    :maxlengthMessage="__(
                                                        'usersmanagement::dashboard.number_of_characters_must_less_than_or_equal_100',
                                                    )" />
                ...
                <div class="form-group row align-items-center px-7">
                    ...
                    <div class="col-3">
                        <x-dashboard.form.inputs.select :id="'profiles'" :name="'profiles[]'" :isRequired="true" :options="$profiles"
                            :requiredMessage="__('usersmanagement::dashboard.profiles_is_required')" :isMultiple="true" :defaultOptionName="__('usersmanagement::dashboard.select_profiles')" :selectedOption="old('profiles')" />
                        <span
