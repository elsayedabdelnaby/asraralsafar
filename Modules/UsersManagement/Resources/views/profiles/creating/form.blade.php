...
@section('title', __('usersmanagement::dashboard.users_management') . ' - ' .
    __('usersmanagement::dashboard.create_profile'))
...
@section('subheader')
    @include('dashboard.layouts.partials.sub_header', [
        'module_name' => __('usersmanagement::dashboard.new_profile'),
        'short_description' => __('usersmanagement::dashboard.enter_profile_details_and_submit'),
        'breadcrumbs' => [],
    ]);
@endsection
...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form parsley-form" enctype="multipart/form-data" method="POST"
            action="{{ route('dashboard.users-management.profiles.store') }}">
            @method('post')
            @csrf
            <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    <x-dashboard.form.inputs.text :id="''" :class="'form-control'"
                                                        :name="'name'" :placeholder="__('usersmanagement::dashboard.profile_name')" :value="$translation['name']"
                                ...
                                <div data-repeater-item class="form-group row align-items-top">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <x-dashboard.form.inputs.text :id="''" :class="'form-control'"
                                                    :name="'name'" :placeholder="__('usersmanagement::dashboard.profile_name')" :value="''"
                                                    :isRequired="true" :requiredMessage="__('usersmanagement::dashboard.name_is_required')" :maxlength="100"
                                                    :maxlengthMessage="__(
                                                        'usersmanagement::dashboard.number_of_characters_must_less_than_or_equal_100',
                                                    )" />
                                            ...
                                            @foreach (getSystemPermissions()->where('model_id', $model->id) as $permission)
                                                ...
                                                <div class="col-2">
                                                    <x-dashboard.form.inputs.success-switch class="mx-2"
                                                        :id="$permission->name" :name="'permissions[' . $permission->id . ']'" :isChecked="false" />
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
