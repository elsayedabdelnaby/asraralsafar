<li class="menu-item menu-item-submenu @if (request()->routeIs('dashboard.locations.*')) menu-item-open menu-item-here @endif"
    ...
    <a href="javascript:;" class="menu-link menu-toggle">
        ...
        <!--end::Svg Icon-->
        <span class="menu-text">{{ __('dashboard.locations') }}</span>
    ...
    <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
            ...
            <li class="menu-item {{ request()->routeIs('dashboard.locations.countries.index') ? 'menu-item-active' : null }}"
                aria-haspopup="true">
                <a href="{{ route('dashboard.locations.countries.index') }}" class="menu-link">
