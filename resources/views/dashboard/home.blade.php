...
@section('head-css')
    <link href="{{ global_asset('metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}"
          rel="stylesheet"
          type="text/css"/>
@endsection
                    ...
                    <div class="timeline timeline-6 mt-3">
                        ...
                        <div class="timeline-item align-items-start">
                            ...
                            <div class="timeline-content font-weight-mormal font-size-lg text-muted pl-3">Outlines keep
                                and
                                you honest. Indulging in poorly driving
                            </div>
                            <!--end::Text-->
                        </div>
                        <!--end::Item-->
...
@push('javascript')
    <script src="{{ global_asset('metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js') }}"></script>
    <script src="{{ global_asset('metronic/assets/js/pages/widgets.js') }}"></script>
    <script src="https://js.pusher.com/7.2/pusher.min.js"></script>
    <script>
        // Enable pusher logging - don't include this in production
        Pusher.logToConsole = true;

        var pusher = new Pusher('5f5a05c84caf33cc5b11', {
            cluster: 'mt1'
        });

        var channel = pusher.subscribe('notification-channel');
        channel.bind('App\\Events\\TestNotificatiosn', function (data) {
    ...
    <script>
        var firebaseConfig = {
            apiKey: "AIzaSyBE8f3h7pdNjNmGNWTYEywF1nQU1mMBqu0",
            authDomain: "wagabat-783d8.firebaseapp.com",
            projectId: "wagabat-783d8",
            storageBucket: "wagabat-783d8.appspot.com",
            messagingSenderId: "139117434266",
            appId: "1:139117434266:web:f9546c318b53c38acb9623",
            measurementId: "G-6XT8BZKT0E"
        };
